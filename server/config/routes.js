...
//     })
    ...
    app.all("*", (req,res,next) => {
        res.sendFile(path.resolve("./belt/dist/index.html"))  // if you don't change this on refresh of angular pages you will get page not found errors!!!
    });
}
